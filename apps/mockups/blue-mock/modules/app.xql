...
module namespace app="http://blaueberg.info/mockup/templates";

import module namespace templates="http://exist-db.org/xquery/templates" ;
import module namespace config="http://blaueberg.info/mockup/config" at "config.xqm";
...
as element()
{
    <ol class='title-listing'>{
        ...
        let $thumbnail := transform:transform($title, $xsl, $xslt-parameters)
        return
            <li>{ $thumbnail }</li>
    }</ol>
};
