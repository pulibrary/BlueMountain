...
kdu_opts = '-no_weights -rate 1,0.84,0.7,0.6,0.5,0.4,0.35,0.3,0.25,0.21,0.18,0.15,0.125,0.1,0.088,0.075,0.0625,0.05,0.04419,0.03716,0.03125,0.025,0.0221,0.01858,0.015625 Stiles=\{1024,1024\} Clevels=6 Corder=RLCP'

def convert_images(sourcedir, targetdir):
    '''Convert basic jp2 files to NDNP-like jp2 files.'''
