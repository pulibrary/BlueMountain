...
*** Generative Image Derivatives
   ...
   #+BEGIN_EXAMPLE
      kdu_compress -i YOURINPUT.tif -o YOUROUTPUT.jp2  \
...
** Page Types
   ...
   - inside
** Zone Types
   - Byline :: a short phrase that indicates the name of the author or
               creator of a magazine constituent.  It sometimes begins
               with the word /by/ (English) /von/ (German) or /par/
               (French), followed by the author or creator's name,
               often printed in all caps.  The byline commonly appears
               between the head of the constituent and the start of
               the copy, where it is usually printed flush left or
               centered; it may also appear at the end of a
               constituent, where it is commonly printed flush right.

   - Caption :: A title or description of a piece of magazine art,
                usually appearing below the graphic.  The byline is
                sometimes conjoined.

   - Copy :: The textual portion of a magazine constituent, as
             distiguished from graphics or illustrations.

   - CoverLine :: A short statement printed on the cover of the
                  magazine, usually alluding to the constituents
                  inside.

   - FolioLine :: a line (sometimes several) containing information
                  about the magazine: metadata.  FolioLines on the
                  outside front cover often contain the volume number,
                  the issue number, and the location and date of
                  publication; FolioLines on inner pages sometimes
                  function as running heads or feet and often contain
                  a page number.

   - Head :: One or more lines of text, usually set in a larger
             typeface than body copy, that introduces constituents or
             subsections of constituents.  The largest, topmost head
             in a constituent usually displays the title. (see
             /subhead./)

   - Masthead :: Often confused with /Nameplate/.  A listing printed
                 in all issues of a magazine (usually in the first few
                 pages) naming the editorial staff and other metadata.

   - Nameplate :: A large element usually appearing at the top of the
                  outer front cover, containing the name of the
                  magazine, usually in distinctive display type, and
                  sometimes a graphic logo.  It is sometimes repeated
                  on one of the first inner pages. (See /Masthead./)

   - Subhead :: A kind of /head/, set in smaller type than the main
                head, that introduces a subsection of a constituent.
** Structure/Hierarchy Types
   - Constituent :: A generic component of a magazine.  For Blue
                    Mountain, we do not distinguish, at the METS/ALTO
                    level, among various kinds of magazine content.
                    All composites of layout elements are /constituents/.
